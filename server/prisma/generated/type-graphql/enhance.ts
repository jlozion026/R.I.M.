...
const modelsInfo = {
  ...
  Report: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter_id"],
...
const outputsInfo = {
  ...
  ReportGroupBy: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter_id", "_count", "_min", "_max"],
  ...
  ReportCountAggregate: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter_id", "_all"],
  ReportMinAggregate: ["report_id", "createdAt", "updatedAt", "description", "reporter_id"],
  ReportMaxAggregate: ["report_id", "createdAt", "updatedAt", "description", "reporter_id"],
...
const inputsInfo = {
  ...
  ReportWhereInput: ["AND", "OR", "NOT", "report_id", "createdAt", "updatedAt", "location", "description", "reporter", "reporter_id", "city_porject", "incident"],
  ReportOrderByWithRelationInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter", "reporter_id", "city_porject", "incident"],
  ReportWhereUniqueInput: ["report_id"],
  ReportOrderByWithAggregationInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter_id", "_count", "_max", "_min"],
  ReportScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "report_id", "createdAt", "updatedAt", "location", "description", "reporter_id"],
  ...
  ReportCreateInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter", "city_porject", "incident"],
  ReportUpdateInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter", "city_porject", "incident"],
  ReportCreateManyInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter_id"],
  ReportUpdateManyMutationInput: ["report_id", "createdAt", "updatedAt", "location", "description"],
  ...
  ReportCountOrderByAggregateInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter_id"],
  ReportMaxOrderByAggregateInput: ["report_id", "createdAt", "updatedAt", "description", "reporter_id"],
  ReportMinOrderByAggregateInput: ["report_id", "createdAt", "updatedAt", "description", "reporter_id"],
  ...
  ReportCreateWithoutReporterInput: ["report_id", "createdAt", "updatedAt", "location", "description", "city_porject", "incident"],
  ...
  ReportScalarWhereInput: ["AND", "OR", "NOT", "report_id", "createdAt", "updatedAt", "location", "description", "reporter_id"],
  ...
  ReportCreateWithoutCity_porjectInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter", "incident"],
  ReportCreateOrConnectWithoutCity_porjectInput: ["where", "create"],
  ReportUpsertWithoutCity_porjectInput: ["update", "create"],
  ReportUpdateWithoutCity_porjectInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter", "incident"],
  ReportCreateWithoutIncidentInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter", "city_porject"],
  ReportCreateOrConnectWithoutIncidentInput: ["where", "create"],
  ReportUpsertWithoutIncidentInput: ["update", "create"],
  ReportUpdateWithoutIncidentInput: ["report_id", "createdAt", "updatedAt", "location", "description", "reporter", "city_porject"],
  ReportCreateManyReporterInput: ["report_id", "createdAt", "updatedAt", "location", "description"],
  ReportUpdateWithoutReporterInput: ["report_id", "createdAt", "updatedAt", "location", "description", "city_porject", "incident"]
};
