...
const modelsInfo = {
  ...
  Report: ["report_id", "createdAt", "updatedAt", "location", "description", "report_type", "reporter_id"],
...
const outputsInfo = {
  ...
  ReportGroupBy: ["report_id", "createdAt", "updatedAt", "location", "description", "report_type", "reporter_id", "_count", "_min", "_max"],
  ...
  ReportCountAggregate: ["report_id", "createdAt", "updatedAt", "location", "description", "report_type", "reporter_id", "_all"],
  ReportMinAggregate: ["report_id", "createdAt", "updatedAt", "description", "report_type", "reporter_id"],
  ReportMaxAggregate: ["report_id", "createdAt", "updatedAt", "description", "report_type", "reporter_id"],
...
const inputsInfo = {
  ...
  ReportCountOrderByAggregateInput: ["report_id", "createdAt", "updatedAt", "location", "description", "report_type", "reporter_id"],
  ReportMaxOrderByAggregateInput: ["report_id", "createdAt", "updatedAt", "description", "report_type", "reporter_id"],
  ReportMinOrderByAggregateInput: ["report_id", "createdAt", "updatedAt", "description", "report_type", "reporter_id"],
  ...
  ReportScalarWhereInput: ["AND", "OR", "NOT", "report_id", "createdAt", "updatedAt", "location", "description", "report_type", "reporter_id"],
