...
const outputsInfo = {
  ...
  AccountGroupBy: ["acc_id", "email", "password", "acc_type", "_count", "_min", "_max"],
  AggregateReport: ["_count", "_min", "_max"],
  ReportGroupBy: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id", "_count", "_min", "_max"],
  ...
  IncidentGroupBy: ["incident_id", "incident_type", "date_started", "date_ended", "reports_id", "_count", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  AccountCount: ["reports"],
  AccountCountAggregate: ["acc_id", "email", "password", "acc_type", "_all"],
  AccountMinAggregate: ["acc_id", "email", "password", "acc_type"],
  AccountMaxAggregate: ["acc_id", "email", "password", "acc_type"],
  ReportCountAggregate: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id", "_all"],
  ReportMinAggregate: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id"],
  ReportMaxAggregate: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id"],
  ...
  IncidentCountAggregate: ["incident_id", "incident_type", "date_started", "date_ended", "reports_id", "_all"],
  IncidentMinAggregate: ["incident_id", "incident_type", "date_started", "date_ended", "reports_id"],
  IncidentMaxAggregate: ["incident_id", "incident_type", "date_started", "date_ended", "reports_id"]
};
...
const inputsInfo = {
  AccountWhereInput: ["AND", "OR", "NOT", "acc_id", "email", "password", "acc_type", "reports"],
  AccountOrderByWithRelationInput: ["acc_id", "email", "password", "acc_type", "reports"],
  AccountWhereUniqueInput: ["acc_id", "email"],
  AccountOrderByWithAggregationInput: ["acc_id", "email", "password", "acc_type", "_count", "_max", "_min"],
  AccountScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "acc_id", "email", "password", "acc_type"],
  ReportWhereInput: ["AND", "OR", "NOT", "report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter", "reporter_id", "city_porject", "incident"],
  ReportOrderByWithRelationInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter", "reporter_id", "city_porject", "incident"],
  ReportWhereUniqueInput: ["report_id"],
  ReportOrderByWithAggregationInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id", "_count", "_max", "_min"],
  ReportScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id"],
  ...
  IncidentWhereInput: ["AND", "OR", "NOT", "incident_id", "incident_type", "date_started", "date_ended", "report", "reports_id"],
  IncidentOrderByWithRelationInput: ["incident_id", "incident_type", "date_started", "date_ended", "report", "reports_id"],
  IncidentWhereUniqueInput: ["incident_id", "reports_id"],
  IncidentOrderByWithAggregationInput: ["incident_id", "incident_type", "date_started", "date_ended", "reports_id", "_count", "_max", "_min"],
  IncidentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "incident_id", "incident_type", "date_started", "date_ended", "reports_id"],
  AccountCreateInput: ["acc_id", "email", "password", "acc_type", "reports"],
  AccountUpdateInput: ["acc_id", "email", "password", "acc_type", "reports"],
  AccountCreateManyInput: ["acc_id", "email", "password", "acc_type"],
  AccountUpdateManyMutationInput: ["acc_id", "email", "password", "acc_type"],
  ReportCreateInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter", "city_porject", "incident"],
  ReportUpdateInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter", "city_porject", "incident"],
  ReportCreateManyInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id"],
  ReportUpdateManyMutationInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description"],
  ...
  IncidentCreateInput: ["incident_id", "incident_type", "date_started", "date_ended", "report"],
  IncidentUpdateInput: ["incident_id", "incident_type", "date_started", "date_ended", "report"],
  IncidentCreateManyInput: ["incident_id", "incident_type", "date_started", "date_ended", "reports_id"],
  IncidentUpdateManyMutationInput: ["incident_id", "incident_type", "date_started", "date_ended"],
  ...
  AccountCountOrderByAggregateInput: ["acc_id", "email", "password", "acc_type"],
  AccountMaxOrderByAggregateInput: ["acc_id", "email", "password", "acc_type"],
  AccountMinOrderByAggregateInput: ["acc_id", "email", "password", "acc_type"],
  ...
  ReportCountOrderByAggregateInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id"],
  ReportMaxOrderByAggregateInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id"],
  ReportMinOrderByAggregateInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id"],
  ...
  IncidentCountOrderByAggregateInput: ["incident_id", "incident_type", "date_started", "date_ended", "reports_id"],
  IncidentMaxOrderByAggregateInput: ["incident_id", "incident_type", "date_started", "date_ended", "reports_id"],
  IncidentMinOrderByAggregateInput: ["incident_id", "incident_type", "date_started", "date_ended", "reports_id"],
  ...
  ReportCreateWithoutReporterInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "city_porject", "incident"],
  ...
  ReportScalarWhereInput: ["AND", "OR", "NOT", "report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter_id"],
  AccountCreateWithoutReportsInput: ["acc_id", "email", "password", "acc_type"],
  ...
  IncidentCreateWithoutReportInput: ["incident_id", "incident_type", "date_started", "date_ended"],
  IncidentCreateOrConnectWithoutReportInput: ["where", "create"],
  AccountUpsertWithoutReportsInput: ["update", "create"],
  AccountUpdateWithoutReportsInput: ["acc_id", "email", "password", "acc_type"],
  ...
  IncidentUpdateWithoutReportInput: ["incident_id", "incident_type", "date_started", "date_ended"],
  ReportCreateWithoutCity_porjectInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter", "incident"],
  ReportCreateOrConnectWithoutCity_porjectInput: ["where", "create"],
  ReportUpsertWithoutCity_porjectInput: ["update", "create"],
  ReportUpdateWithoutCity_porjectInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter", "incident"],
  ReportCreateWithoutIncidentInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter", "city_porject"],
  ReportCreateOrConnectWithoutIncidentInput: ["where", "create"],
  ReportUpsertWithoutIncidentInput: ["update", "create"],
  ReportUpdateWithoutIncidentInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "reporter", "city_porject"],
  ReportCreateManyReporterInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description"],
  ReportUpdateWithoutReporterInput: ["report_id", "createdAt", "updatedAt", "published", "location", "description", "city_porject", "incident"]
};
